...
if __name__ == '__main__':
	...
	while True:
		...
		elif "human 22" in query:
			print(("Name: Adhip Pratap Singh\n" "Gender: Male\n" "Height: Burj Khalifa (not Mia Khalifa)\n" "GK Level: 10/10"))
			speak("God in human form. Absolute madlad. The word literally means King.")
		elif "human 23" in query:
			print("Name: Vaishnavi Singh\n" "Gender: Female\n" "Height: Lower than average\n" "IQ Level: Highest in Class")
			speak("Miss Vaishnavi is a good friend to my father at his school. She excels at academics in every subject, and has a great personality. She is down to earth, kind-hearted and a optimist. Even though surrounded by distractions, she finds a way to get perfect scores in exams. Additionally an awesome person, funny, crazy, very intelligent. Loves to try everything and extremely curious. Non-judgmental. Naive. ")
